...
<Info>Modules marked as Spectr Premium will **not show up on the Configuration menu** unless you have a slot regisered to the server.</Info>
    
In order to begin customizing Spectr to your server's liking you must run the `/config` command. This will bring up the configuration embed and allow you to select which modules to would like to configure.
