...
<Warning>Users must have the **Management Role** permissions via the /config command to use thius module.</Warning>

The infraction module that allows server management to help better manage their staff team and by giving them the ability to issue punishments to any member of your staff team at any give time. 
## Configuration

<Info>This module contains elements from your the Customization Module.</Info>
