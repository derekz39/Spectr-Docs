...
<Warning>Users must have the **Management Role** permissions via the /config command to use this module.</Warning>

Spectr's Infraction module provides server managers with the tools they need to effectively manager their staff team. With this feature, managers can issue punishments to any team member at any time.
## Configuration
